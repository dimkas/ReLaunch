                    ...
                    if (eBook.isOk) {
                        ...
                        if (eBook.authors.size() > 0) {
                            ...
                            if (eBook.sequenceName != null && eBook.sequenceName.length() != 0) {
                                ...
                                newDir = new File(fileMoveDir + eBook.sequenceName + File.separator);
                                if(!newDir.isDirectory()){
                                    if (app.createDir(fileMoveDir + eBook.sequenceName + File.separator)){
                                        fileMoveDir += eBook.sequenceName + File.separator;
                                    }
                                }else{
                                    fileMoveDir += eBook.sequenceName + File.separator;
                                }
